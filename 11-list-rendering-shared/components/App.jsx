...
class App extends Component {
    ...
    changeMovieStatus = (likeStatus, movieName) => {
        ...
        this.setState(
            ...
            (prevState) => {
                ...
                const movieIndex = prevState.movies.findIndex(movie => movie.name === movieName);

                // Editamos de movies el elemento que encontramos.
                prevState.movies[movieIndex].status = likeStatus;
    ...
    deleteMovie = (movieName) => {
        this.setState(
            ...
            (prevState) => {
                ...
                const movies = prevState.movies.filter(movie => movie.name !== movieName);
    ...
    render() {
        ...
        const likedMovies = this.state.movies.filter(movie => movie.status === "like");
        const dislikedMovies = this.state.movies.filter(movie => movie.status === "dislike");
        const neutralMovies = this.state.movies.filter(movie => movie.status === "");
